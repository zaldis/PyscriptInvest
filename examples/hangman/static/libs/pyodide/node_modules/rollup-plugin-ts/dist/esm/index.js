...
import { readConfig as readConfig$1, findConfig } from 'browserslist';
...
function getPluginOptions(options) {
    ...
    const { browserslist, transpiler = "typescript", typescript = TSModule, cwd = path.normalize(process.cwd()), tsconfig, transformers, include = [], exclude = [], transpileOnly = false, debug = false, fileSystem = typescript.sys, hook = {} } = options;
    ...
    if (browserslist != null) {
        ...
        // If the Browserslist is a config with a path, attempt to resolve the Browserslist from that property
            ...
            if (!fileSystem.fileExists(path.native.normalize(browserslistPath))) {
                ...
                // Read the config
                const match = readConfig$1(browserslistPath);
                if (match == null) {
                    throw new ReferenceError(errorMessage);
                }
                else {
...
function visitModuleDeclaration$9(_a) {
    var { node } = _a, options = __rest(_a, ["node"]);
    if (node.body == null)
        return;
...
function visitClassDeclaration$5(_a) {
    var { node, typescript, markAsExported } = _a, options = __rest(_a, ["node", "typescript", "markAsExported"]);
...
function visitVariableStatement$5(_a) {
    var { node, typescript, sourceFile, markAsExported } = _a, options = __rest(_a, ["node", "typescript", "sourceFile", "markAsExported"]);
    // If the node has no export modifier, leave it as it is
    if (!hasExportModifier(node, typescript))
        return;
    ...
    return options => {
        ...
        const visitorOptions = Object.assign(Object.assign(Object.assign({}, options), nodePlacementQueue), { transformers, payload: undefined, childContinuation: (node, payload) => typescript.visitEachChild(node, nextNode => nodePlacementQueue.wrapVisitResult(visitNode$8(Object.assign(Object.assign({}, visitorOptions), { payload, node: nextNode }))), context), continuation: (node, payload) => nodePlacementQueue.wrapVisitResult(visitNode$8(Object.assign(Object.assign({}, visitorOptions), { payload,
            ...
            includeSourceFile(sourceFileToInclude, _a = {}) {
                var { allowDuplicate = false, allowExports = options.otherEntrySourceFilesForChunk.some(otherEntrySourceFileForChunk => otherEntrySourceFileForChunk.fileName === sourceFileToInclude.fileName), transformers: extraTransformers = [] } = _a, otherOptions = __rest(_a, ["allowDuplicate", "allowExports", "transformers"]);
...
function checkNode(_a) {
    var _b, _c;
    var { node, originalNode } = _a, options = __rest(_a, ["node", "originalNode"]);
...
function isReferenced(_a) {
    var { seenNodes = new Set() } = _a, options = __rest(_a, ["seenNodes"]);
...
function resolveId(_a) {
    var { resolveCache } = _a, options = __rest(_a, ["resolveCache"]);
...
function getBabelConfig({ babel, babelConfig, cwd, forcedOptions = {}, defaultOptions = {}, browserslist, phase, hook }) {
    return (filename) => {
        ...
        const { presets: forcedPresets, plugins: forcedPlugins } = forcedOptions, otherForcedOptions = __rest(forcedOptions, ["presets", "plugins"]);
        const { presets: defaultPresets, plugins: defaultPlugins } = defaultOptions, otherDefaultOptions = __rest(defaultOptions, ["presets", "plugins"]);
